...
var spongegar = {name: 'SpongeGar', hp: 160, max_hp: 160, armor: 0, img: 'img/Heroes/spongegar.png', m1: 'Intimidate', m1_energy: 3, m1_dmg: 30, m1_effect: 'SpongeGar has +10 armor this turn.', m2: 'React', m2_energy: 5, m2_dmg: 50, m2_effect: '', energy: 0, energy_left: 0, intimidate: false};
...
var doge = {name: "Doge", hp: 150, max_hp: 150, armor: 0, img: 'img/Heroes/doge.png', m1: 'Such Treat', m1_energy: 2, m1_dmg: 20, m1_effect: 'Flip a coin. If heads, get an item.', m2: 'So Wow', m2_energy: 5, m2_dmg: 60, m2_effect: '', energy: 0, energy_left: 0, suchTreat: false};
...
var harambe = {name: 'Harambe', hp: 200, max_hp: 200, armor: 0, img: 'img/Heroes/harambe2.jpg', m1: 'Drag', m1_energy: 2, m1_dmg: 20, m1_effect: '', m2: 'Dicks Out', m2_energy: 4, m2_dmg: 50, m2_effect: 'For every remaining like, +10 damage', energy: 0, energy_left: 0};
...
var rickHarrison = {name: 'Rick Harrison', hp: 150, max_hp: 150, armor: 0, img: 'img/Heroes/rickHarrison.png', m1: 'Best I Can Do', m1_energy: 3, m1_dmg: '20', m1_effect: '', m2: 'Call In An Expert', m2_energy: 5, m2_dmg: 50, m2_effect: "It's just something I don't know alot about<br>For every epic support +10 dmg.", energy: 0, energy_left: 0};
...
var surprisedPatrick = {name: "Surprised Patrick", img: 'img/supports/surprisedPatrick.png', effect: "Your opponent can't attack next turn"};
basicSupp[0] = meGusta; basicSupp[1] = foreverAlone; basicSupp[2] = iFeelIt; basicSupp[3] = surprisedPatrick;
var basicArr = {
  0:basicSupp.slice(0),
  1:basicSupp.slice(0)
};
